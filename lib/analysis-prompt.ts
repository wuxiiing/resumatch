...
JSON object 必须符合 AnalysisReport 结构，字段包括 score、summary、jobDirection、matchedKeywords、missingKeywords、suggestions、history、segments。
